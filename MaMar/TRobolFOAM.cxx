...
void TRobolFOAM::Initialize(long &NevTot)
{
  ...
  cout<<" TRobolFOAM::Initialize:  NevTot = "<<NevTot<<endl;
  //  ************* user histograms  *************
...
//  MC_Gen5->Initialize();       // Initialize simulator, may take time...
  MC_Gen5->Initialize(PseRan,LibSem);       // Initialize simulator, may take time...
...
//  MC_Gen3 = new TFoam("MC_Gen3");   // Create Simulator
  ...
  MC_Gen3->Initialize(PseRan,LibSem);       // Initialize simulator, may take time...
...
}//TRobolFOAM::Initialize

///////////////////////////////////////////////////////////////////////////////
void TRobolFOAM::Production(long &iEvent)
{
/////////////////////////////////////////////////////////////////////////
//
...
void TRobolFOAM::KKMC_NORMA()
{
  ...
  cout<<" TRobolFOAM::KKMC_NORMA: m_Xsav5, m_NevGen ="<< m_Xsav5 <<"  "<< m_NevGen << endl;
}// TRobolFOAM::KKMC_NORMA
...
void TRobolFOAM::ReaData(char DiskFile[], int imax, double xpar[])
//////////////////////////////////////////////////////////////
