...
//TFile DiskFileF91("../workFoam3/histo.root_91GeV_kksem_180M"); // KKsemBorn
//TFile DiskFileF95("../workFoam3/histo.root_95GeV_kksem_80M");  // kksemBorn
//TFile DiskFileF88("../workFoam3/histo.root_88GeV_kksem_110M"); // kksemBorn
...
//////////////////////////////////////////////////////////////////
  ...
  TH2D *SCT_xc_EEX2i9   = (TH2D*)DiskFileF95.Get("SCT_Lxc_EEX2i");    // FOAM small range x<0.20
  TH2D *SCT_xc_EEX2n9   = (TH2D*)DiskFileF95.Get("SCT_Lxc_EEX2n");    // FOAM small range x<0.20
...
//   NbMax=0;
////////////////------------------95GeV-------------------------------////////
   TH1D  *Hafb2_xmax_EEX2i9 = HstProjAv("Hafb2_xmax_EEX2i9",SCT_xc_EEX2i9,NbMax); //  x<0.20
   TH1D  *Hafb2_xmax_EEX2n9 = HstProjAv("Hafb2_xmax_EEX2n9",SCT_xc_EEX2n9,NbMax); //  x<0.20
   TH1D  *Hafb1_xmax_EEX2i9 = HstProjAv("Hafb1_xmax_EEX2i9",SCN_xc_EEX2i9,NbMax); //  x<0.02
   TH1D  *Hafb1_xmax_EEX2n9 = HstProjAv("Hafb1_xmax_EEX2n9",SCN_xc_EEX2n9,NbMax); //  x<0.02
///////////////---------------- 88GeV-------------------------------////////
...
//****************************************************************************************
  ...
  TH2D *sct_vTcPR_Ceex2i9  = (TH2D*)DiskFileA95.Get("sct_LvTcPR_Ceex2");  //!!!!!!!!!!!!!!
  TH2D *sct_vTcPR_Ceex2n9  = (TH2D*)DiskFileA95.Get("sct_LvTcPR_Ceex2n"); //!!!!!!!!!!!!!!

  TH2D *sct_vAcPR_Ceex2i9  = (TH2D*)DiskFileA95.Get("sct_LvAcPR_Ceex2");  //!!!!!!!!!!!!!!
  TH2D *sct_vAcPR_Ceex2n9  = (TH2D*)DiskFileA95.Get("sct_LvAcPR_Ceex2n"); //!!!!!!!!!!!!!!
...
//==================
  TH1D *HAfb9_vB_Ceex2   = HstProjAv("HAfb9_vB_Ceex2", sct_vTcPR_Ceex2i9,NbMax); //  x<0.20
  TH1D *HAfb9_vB_Ceex2n  = HstProjAv("HAfb9_vB_Ceex2n",sct_vTcPR_Ceex2n9,NbMax); //  x<0.20
//
  TH1D *HAfb9_vA_Ceex2   = HstProjAv("HAfb9_vA_Ceex2",  sct_vAcPR_Ceex2i9,NbMax); //  x<0.20
  TH1D *HAfb9_vA_Ceex2n  = HstProjAv("HAfb9_vA_Ceex2n", sct_vAcPR_Ceex2n9,NbMax); //  x<0.20
//==================
...
//------------------------------------------------------------------------
  ...
  TH1D *HAfb9_vA_Ceex2  = (TH1D*)DiskFileB.Get("HAfb9_vA_Ceex2");  // kkmc
  TH1D *HAfb9_vA_Ceex2n = (TH1D*)DiskFileB.Get("HAfb9_vA_Ceex2n"); // kkmc

  TH1D *HAfb9_vB_Ceex2  = (TH1D*)DiskFileB.Get("HAfb9_vB_Ceex2");  // kkmc
  TH1D *HAfb9_vB_Ceex2n = (TH1D*)DiskFileB.Get("HAfb9_vB_Ceex2n"); // kkmc

  TH1D *Hafb2_xmax_EEX2i9 =(TH1D*)DiskFileB.Get("Hafb2_xmax_EEX2i9"); // kkfoam3
  TH1D *Hafb2_xmax_EEX2n9 =(TH1D*)DiskFileB.Get("Hafb2_xmax_EEX2n9"); // kkfoam3
