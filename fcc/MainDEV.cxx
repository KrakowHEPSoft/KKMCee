...
int main(int argc, char **argv)
{
  ...
  cout    <<endl<<flush;
  cout    << "  |--------------------| "<<endl<<flush;
  cout    << "  | MainDEV  Entering  | "<<endl<<flush;
  cout    << "  |--------------------| "<<endl<<flush;
  OutFile <<endl<<flush;
  OutFile << "  |--------------------| "<<endl<<flush;
  OutFile << "  | MainDEV  Entering  | "<<endl<<flush;
  OutFile << "  |--------------------| "<<endl<<flush;
  ...
  cout<< "||||||||||||||||||||||||||||||||||||||||||||||||||"<<endl;
  cout<< "|| MainDEV: to be generated "<<NevTot<< " events "<<endl;
  cout<< "||||||||||||||||||||||||||||||||||||||||||||||||||"<<endl;
  ///***********************************************************************
  ...
  cout    <<endl<<flush;
  cout    << "  |--------------------| "<<endl<<flush;
  cout    << "  |  MainDEV  Ended    | "<<endl<<flush;
  cout    << "  |--------------------| "<<endl<<flush;
  OutFile <<endl<<flush;
  OutFile << "  |--------------------| "<<endl<<flush;
  OutFile << "  |  MainDEV  Ended    | "<<endl<<flush;
  OutFile << "  |--------------------| "<<endl<<flush;
  return 0;
  }
