...
*//////////////////////////////////////////////////////////////////////////////////////
      ...
      DOUBLE PRECISION  aph(5), bph(5), rem1(4),rem2(4)
...
c[[[%      CALL KarLud_GetKFfin(KFfin)
* Beams and ISR photons
c[[[%      CALL KarLud_GetPhotons(nphox,xphot)
c[[[%      CALL KarLud_GetBeams(pf1,pf2)
* Final fermions and FSR photons
c[[[%      CALL KarFin_GetPhotons(nphoy,yphot)
c[[[%      CALL KarFin_GetFermions(qf1,qf2)
      CALL Globux_GetEvent(KFbeam,KFfin,amel,amfin,pf1,pf2,qf1,qf2,nphox,nphoy,xphot,yphot,rem1,rem2)
c[[[[[[[
c      write(16,*) '-----------------------------------------------------------------------------------'
c      write(16,*) '>>>>>HepEvt_Fill: KFbeam=',KFbeam,'   KFfin=',KFfin
c      write(16,*) '>>>>>HepEvt_Fill:   amel=',amel  ,'   amfin=',amfin
c      write(16,*) '>>>>>HepEvt_Fill:   amel=',amel  ,'   amfin=',amfin
c      write(16,*) '>>>>>HepEvt_Fill: pf1=',(pf1(i),i=1,4)
c      write(16,*) '>>>>>HepEvt_Fill: pf2=',(pf2(i),i=1,4)
c      write(16,*) '>>>>>HepEvt_Fill: qf1=',(qf1(i),i=1,4)
c      write(16,*) '>>>>>HepEvt_Fill: qf2=',(qf2(i),i=1,4)
c      write(16,*) '>>>>>HepEvt_Fill: rem1=',(rem1(i),i=1,4)
c      write(16,*) '>>>>>HepEvt_Fill: rem2=',(rem2(i),i=1,4)
c      write(16,*) '>>>>>HepEvt_Fill: nphox=',nphox,'  nphoy=',nphoy
c      DO i=1,nphox
c        write(16,*) '>>>>>HepEvt_Fill: xphot=',(xphot(i,j),j=1,4)
c      ENDDO
c      DO i=1,nphoy
c        write(16,*) '>>>>>HepEvt_Fill: yphot=',(yphot(i,j),j=1,4)
c      ENDDO
c]]]]]]]
      DO j=1,4
         Psum(j)=qf1(j)+qf2(j)
      ENDDO
c[[[%      CALL  KK2f_GetKFini(KFbeam)
c[[[%      amel =BornV_GetMass(KFbeam)
* Beams
      ip=1                      !(&&&
...
c[[[%      CALL KarLud_GetBeasts( aph, bph)
      DO j=1,4
         aph(j) = rem1(j)
         bph(j) = rem2(j)
      END DO
