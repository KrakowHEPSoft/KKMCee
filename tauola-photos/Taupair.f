...
c[[[         CALL      GPS_SetHvectors( HvecFer1,HvecFer2)
c[[[         CALL GPS_MakeRho2(wt0,wt1,wt2)
      CALL GPS_MakeRho2(HvecFer1,HvecFer2,wt0,wt1,wt2)
*        --------------------------
         wt = wt1
...
c[[[      CALL GPS_tralorPrepare(p3,1)
c[[[      CALL GPS_tralorPrepare(p4,2)
