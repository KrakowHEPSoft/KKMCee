...
*/////////////////////////////////////////////////////////////////////////////////////////////
      ...
      DOUBLE COMPLEX     V1,V2, cL, V2a
      DOUBLE COMPLEX     BVR_CnuA
      DOUBLE PRECISION   p3p4,Svar,s3,s4,zz,r3,r4
      DOUBLE PRECISION   BVR_Dilog
      INTEGER icont
      DATA    icont /0/
*
      ...
      r3 = (p3(4)*ph(4)-p3(3)*ph(3)-p3(2)*ph(2)-p3(1)*ph(1))/p3p4
      r4 = (p4(4)*ph(4)-p4(3)*ph(3)-p4(2)*ph(2)-p4(1)*ph(1))/p3p4
...
* FSR formula of Eq (3.31) of Phys. Rev. D65, p.073030
      V2 = (Alfpi*Q**2) *0.5d0*(
     $     -DLOG(s3)*DLOG(1-s4)     -DLOG(s4)*DLOG(1-s3)   !! LL part
     $     -3d0/2*DLOG(1-s3)        -3d0/2*DLOG(1-s4)      !! NLL this and all the rest
     $     -BVR_Dilog(s3)           -BVR_Dilog(s4)
     $     -1d0/2*s3/(1+(1-s3)**2)  -1d0/2*s4/(1+(1-s4)**2)
     $     )
      END
