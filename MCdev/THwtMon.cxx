...
/// should not be used by the user
  cout<< "||||> THwtMon::THwtMon: DEFAULT Constructor (for ROOT only) "<<endl;
}///THwtMon


///////////////////////////////////////////////////////////////////////////////
THwtMon::THwtMon(const char* name):
  TH1D(name, " THwtMon histogram", 10, 0.0, 1.0)
{
  // principal constructor
  cout<< "||||> THwtMon::THwtMon: User Constructor "<<endl;
  m_Xup =1.0;
  m_Ntot = 0.0;
  m_Nacc = 0.0;
  m_Nzer = 0.0;
...
///////////////////////////////////////////////////////////////////////////////
THwtMon::THwtMon(const char* name, const char* title, int nbinsx, const double xup):
  TH1D(name, title, nbinsx, 0.0, xup){
  // principal constructor
  cout<< "||||> THwtMon::THwtMon: User principal Constructor "<<endl;
  m_Xup = xup;
  m_Ntot = 0.0;
  m_Nacc = 0.0;
  m_Nzer = 0.0;
...
///////////////////////////////////////////////////////////////////////////////
int THwtMon::Fill(const double wt){
...
///////////////////////////////////////////////////////////////////////////////
int THwtMon::Fill(const double wt, const double rand){
...
///////////////////////////////////////////////////////////////////////////////
void THwtMon::GetAver(double& AveWt, double& ErrAbs){
...
void THwtMon::GetAll(
  ...
  long Nbin = TH1D::GetNbinsX();
  AvUnd=0.0;
  AvOve=0.0;
  if(m_Ntot != 0.0) {
    AvUnd=TH1D::GetBinContent(0)/m_Ntot;
  ...
  Nacc  = m_Nacc;
  Nzer  = m_Nzer;
  Nneg  = TH1D::GetBinContent(0);
  Nove  = TH1D::GetBinContent(Nbin+1);
}
///////////////////////////////////////////////////////////////////////////////
void THwtMon::PrintAll(){
  ...
  const char *title=TH1D::GetTitle();
  cout<<"///////////////////////////// "<<title;
  cout<<" /////////////////////////////"<<endl;
