...
srcdir = /home/jadach/SandBox/KKMC-all-2012
top_srcdir = /home/jadach/SandBox/KKMC-all-2012
VPATH = /home/jadach/SandBox/KKMC-all-2012
pkgdatadir = $(datadir)/KKMC
pkglibdir = $(libdir)/KKMC
pkgincludedir = $(includedir)/KKMC
top_builddir = .
...
ACLOCAL = ${SHELL} /home/jadach/SandBox/KKMC-all-2012/missing --run aclocal-1.9
AMDEP_FALSE = #
AMDEP_TRUE = 
AMTAR = ${SHELL} /home/jadach/SandBox/KKMC-all-2012/missing --run tar
AUTOCONF = ${SHELL} /home/jadach/SandBox/KKMC-all-2012/missing --run autoconf
AUTOHEADER = ${SHELL} /home/jadach/SandBox/KKMC-all-2012/missing --run autoheader
...
FLIBS =  -L/usr/lib/gcc/x86_64-redhat-linux/4.1.2 -L/usr/lib/gcc/x86_64-redhat-linux/4.1.2/../../../../lib64 -L/lib/../lib64 -L/usr/lib/../lib64 -lgfortranbegin -lgfortran -lm -lgcc_s
...
LIBS = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/jadach/SandBox/KKMC-all-2012/missing --run makeinfo
OBJEXT = o
PACKAGE = KKMC
PACKAGE_BUGREPORT = 
PACKAGE_NAME = 
...
ROOTCFLAGS = -I/usr/local/root/include
ROOTCINT = /usr/local/root/bin/rootcint
ROOTCONF = /usr/local/root/bin/root-config
ROOTEXEC = /usr/local/root/bin/root
...
infodir = ${prefix}/info
install_sh = /home/jadach/SandBox/KKMC-all-2012/install-sh
...
prefix = /home/jadach/SandBox/KKMC-all-2012/
