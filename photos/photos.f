...
c[[[[      REAL*8 PHEP,VHEP
c[[[[      COMMON/PH_HEPEVT/NEVHEP,NHEP,ISTHEP(NMXHEP),IDHEP(NMXHEP),
c[[[[     &JMOHEP(2,NMXHEP),JDAHEP(2,NMXHEP),PHEP(5,NMXHEP),VHEP(4,NMXHEP)
c[[[[      WRITE(*,*) "###1### NEVHEP,NHEP= ", NEVHEP,NHEP
c[[[[      for debug one may comment out return in PHLUPA
c]]]]
      
      CALL PHOTOS_GET
c[[[[      WRITE(*,*) "###2### NEVHEP,NHEP= ", NEVHEP,NHEP ![[[[]]]]
      CALL PHOTOS_MAKE(ID)
c[[[[      WRITE(*,*) "###3### NEVHEP,NHEP= ", NEVHEP,NHEP ![[[[]]]]
      CALL PHOTOS_SET
      END
