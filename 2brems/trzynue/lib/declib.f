...
* ADDING   MATRIX S =SEL+SPO
      ...
      SUBROUTINE ADD5(SEL,SPH ,SFI,SPO ,S3, X)
*     **************************************************
      IMPLICIT NONE
      COMPLEX *16   SEL,S,SS,X,SPH,SFI ,SPO,S3 
      DIMENSION SEL(2,2),S(2,2),SPO(2,2),SFI(2,2),SS(2,2),
     #          SPH(2,2),S3(2,2)
