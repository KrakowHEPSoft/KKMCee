...
*//////////////////////////////////////////////////////////////////////////////
      ...
      DOUBLE PRECISION      m_WtSet,    m_WtBest,   m_Debg,     m_Xenph
...
*
     ...
     $    m_sip,                  ! sign=plus  for signed-spinors ( non-standard, for tests)
     $    m_sim,                  ! sign=minus for signed-spinors ( non-standard, for tests)
