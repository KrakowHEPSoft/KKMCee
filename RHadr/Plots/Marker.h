...
/////////////////////////////////////////////////////////////////////
void Diverg(Int_t kolor, Float_t msize, Float_t x, Float_t y){
  TMarker *mark = new TMarker(x,y, 23);
  mark->SetNDC();
  mark->SetMarkerSize(msize);
  mark->SetMarkerColor(kolor);
  mark->Draw();
}
/////////////////////////////////////////////////////////////////////
void Bullet(Int_t kolor, Float_t msize, Float_t x, Float_t y){
  TMarker *mark = new TMarker(x,y, 8);
  mark->SetNDC();
  mark->SetMarkerSize(msize);
  mark->SetMarkerColor(kolor);
  mark->Draw();
...
/////////////////////////////////////////////////////////////////////
void Triangle(Int_t kolor, Float_t msize, Float_t x, Float_t y){
  TMarker *mark = new TMarker(x,y, 22);
  mark->SetNDC();
  mark->SetMarkerSize(msize);
  mark->SetMarkerColor(kolor);
  mark->Draw();
...
/////////////////////////////////////////////////////////////////////
void Box(Int_t kolor, Float_t msize, Float_t x, Float_t y){
  TMarker *mark = new TMarker(x,y, 21);
  mark->SetNDC();
  mark->SetMarkerSize(msize);
  mark->SetMarkerColor(kolor);
  mark->Draw();
...
/////////////////////////////////////////////////////////////////////
void SetBullet(TH1D *Hst, Int_t kolor, Float_t msize){
  // define plotting style (Born)
  Hst->SetMarkerStyle(8); //bullet
  Hst->SetMarkerColor(kolor); //black
  Hst->SetMarkerSize(msize);
  Hst->SetLineColor(kolor);    //black
}

/////////////////////////////////////////////////////////////////////
void SetTriangle(TH1D *Hst, Int_t kolor, Float_t msize){
  // define plotting style (Born)
...
/////////////////////////////////////////////////////////////////////
void SetDiverg(TH1D *Hst, Int_t kolor, Float_t msize){
  // define plotting style (Born)
  Hst->SetMarkerStyle(23); // inverted triangle
  Hst->SetMarkerColor(kolor); //black
  Hst->SetMarkerSize(msize);
  Hst->SetLineColor(kolor);    //black
}
...
/////////////////////////////////////////////////////////////////////
void SetBox(TH1D *Hst, Int_t kolor, Float_t msize){
  // define plotting style (Born)
