...
//------------------------------------------------------------------------
  ...
  TCanvas *cFig2c1 = new TCanvas("cFig2c1","Fig2c1 photonic", 40,  0, WidPix,HeiPix);
  cFig2c1->SetFillColor(10);
  cFig2c1->cd();
  //void Divide(Int_t nx, Int_t ny, Float_t xmargin, Float_t ymargin, Int_t color)
  cFig2c1->Divide(2, 0, 0.0, 0);
  //||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
  cFig2c1->cd(1);
  ...
  ///////////////////////////////////////////////////////////////////////////////
  WidPix = 1100; HeiPix =  700;
  TCanvas *cFig2c2 = new TCanvas("cFig2c2","Fig2c2 photonic", 80, 40, WidPix,HeiPix);
  cFig2c2->SetFillColor(10);
  cFig2c2->cd();
  //void Divide(Int_t nx, Int_t ny, Float_t xmargin, Float_t ymargin, Int_t color)
  cFig2c2->Divide(2, 0, 0.0, 0);
  //||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
  cFig2c2->cd(1);
  hst_Q2Trig2->SetStats(0);
  hst_Q2Trig2->SetTitle(0);
  hst_Q2Trig2->SetMinimum(0);
